...
def CreateEvalDataset(chunks, question_generation_llm,answer_generation_llm, open_ai_key, eval_groud_truth_dataset, num_eval_questions):
    ...
    for text in tqdm(chunks[:num_eval_questions]):
        messages = prompt_template.format_messages(
            context=text,
    ...
    eval_dataset.to_csv(eval_groud_truth_dataset)
